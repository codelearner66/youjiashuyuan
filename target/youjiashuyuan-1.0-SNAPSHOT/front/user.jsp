...
<div id="top">
    ...
    <div id="center02">
        <div class="layui-row layui-col-space20">
            <div class="layui-col-md2 left"><!--左导航-->
            ...
            <div class="layui-col-md10 right">
                <div class="grid-demo">
                    <div class="layui-row "><%--User信息--%>
                        <div class="layui-col-xs6 right_1">
                            <div  class="grid-demo grid-demo-bg1">
                                <div id="dom1"  class="right1_img">
                                    <%
                                        User user = (User) session.getAttribute("newUser");
                                    %>
                                    <img src="../<%=user.getTouxiang()%>"  />
                                    <span style="font-size: 15px;margin-left: 10px;">当前用户：<%=user.getName()%></span>
                                </div>
                                <div class="right1_vip">
                                    当前会员等级：0
                                </div>
                            </div>
                        </div>
                        <div class="layui-col-xs6 right_2">
                            <div class="grid-demo">
                                <div class="right2_text">
                                    个人简介：<br>
                ...
                <div class="right4">
                    <div class="right4_1">
                        <span style="float: left;font-size: 16px;line-height: 48px;margin-left: 20px;">未完成订单</span>
                        <span style="float: right;font-size: 14px;color: #333333;line-height: 48px;margin-right: 20px;"><a href="order.jsp">查看所有订单</a></span>
                    </div>
                    <div class="right4_2">
