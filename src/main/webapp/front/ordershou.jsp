        ...
        <div class="layui-row layui-col-space20">
            ...
            <div class="layui-col-md10 right">
                ...
                <div style="width: 900px;height: 233px;">
                    <div style="width: 840px; height: 40px; background-color: #f5f5f5; border: 1px solid #e8e8e8;">
                        <p style="margin: 14px 0px; float: left; line-height: 20px; text-indent: 10px; font-size: 14px; color: #ca8f00;">售后申请</p>
                    </div>
                    <div style="width: 840px; height: 40px; float: left; border: 1px solid #e8e8e8; background-color: #f5f5f5;">
                        <span style="width: 25%; float: left; text-align: center; line-height: 20px; margin-top: 10px;"><a href="">订单信息</a></span>
                        <span style="width: 25%; float: left; text-align: center; line-height: 20px; margin-top: 10px;"><a href="">订单号</a></span>
                        <span style="width: 25%; float: left; text-align: center; line-height: 20px; margin-top: 10px;"><a href="">创建时间</a></span>
                        <span style="width: 25%; float: left; text-align: center; line-height: 20px; margin-top: 10px;"><a href="">退款金额</a></span>
                    </div>
                </div>
            </div>
        </div>
